...
\keywords {obstacle recognition, obstacle avoidance, localisation, filtering, clustering, data smoothing, vision, swarm intelligence, grid world, DBSCAN, artificial neural network, multi-layer perceptron, robotics, mitecom}
\end{abstract}
%
