...
When we checked how good the already implemented algorithm worked we discovered, that ot even the goals were recognized suffinciently. The kind of jumoed from one point to the other and most of the time there were more than two goal postst recognized fo one goal. In addition obstacles at least could be recognise, but there was no behaviour to react in a senseful way towards them, like choosing a different path to reach the ball or goal. Moreover it was not possible for the robot to distinguish between obstacles, such as team mate or opposite player. This also can increase the teamplay, when one robots knows, that he does not have to fair his opponent, but instead can give the ball to his team mate, who is closer to the goal the him.
...
We detected, that the information concerning the goal position was very noisy. It was not possible to determine the goals position on less then one meter. We wondered how it at least was possible to score any goal with this "visual impairment".
